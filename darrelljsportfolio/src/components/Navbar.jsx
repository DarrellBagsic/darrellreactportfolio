...
export default function Navbar({logo}) {
  return (
    ...
    <div className = 'w-full flex flex-row justify-between py-5 items-center'>
      <div className = "text-3xl font-extrabold pl-5"> {logo} </div>
      ...
      <button className = "bg-yellow-400 text-xl font-bold px-4 py-2 rounded-full mr-4 "><a href="www.facebook.com">Contact me</a></button>
    </div>
  </nav>
  )
}
